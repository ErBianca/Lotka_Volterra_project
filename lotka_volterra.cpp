...
// Getter
const std::vector<double> &Simulation::getx() const { return x; }
const std::vector<double> &Simulation::gety() const { return y; }
const std::vector<double> &Simulation::getH() const { return H; }
const std::vector<double> &Simulation::gett() const { return t; }

// Punto di equilibrio e_2
double Simulation::e2_x() { return D / C; }
double Simulation::e2_y() { return A / B; }

// Scrive le coordinate di e_2 su file
